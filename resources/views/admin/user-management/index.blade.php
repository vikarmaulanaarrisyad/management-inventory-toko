...
@section('subtitle', 'User Manajemen')
...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <x-card>
                <x-slot name="header">
                    <button onclick="addForm(`{{ route('user-management.store') }}`)"
    ...
    @include('admin.user-management.form')
@endsection
...
@push('scripts')
    <script>
        ...
        function addForm(url, title = 'Form Data Karyawan') {
            $(modal).modal('show');
        ...
        function editForm(url, title = 'Form Data Karyawan') {
            Swal.fire({
                title: "Memuat...",
