...
@section('subtitle', 'Data Customer')
...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <x-card>
                <x-slot name="header">
                    <button onclick="addForm(`{{ route('customer.store') }}`)" class="btn btn-sm btn-primary">
...
@push('scripts')
    <script>
        ...
        function addForm(url, title = 'Form Data Customer') {
            $(modal).modal('show');
        ...
        function editForm(url, title = 'Form Data Customer') {
            Swal.fire({
                title: "Memuat...",
