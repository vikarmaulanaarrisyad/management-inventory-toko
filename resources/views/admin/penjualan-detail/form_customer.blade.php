<x-modal class="modal-tambah-customer" data-backdrop="static" data-keyboard="false" size="modal-md">
    <x-slot name="title">
        Tambah
    </x-slot>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-12">
            <div class="form-group">
                ...
                <input id="nama_toko" class="form-control" type="text" name="nama_toko" autocomplete="off">
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-12">
            <div class="form-group">
                ...
                <input id="nomorhp" class="form-control" type="text" name="nomorhp" autocomplete="off">
            </div>
        </div>
    </div>
    <div class="row">
